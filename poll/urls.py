...
urlpatterns = [
    ...
    path('<int:poll_id>/contestants/',
         ContestantListView.as_view(), name='contestant-list'),
    path('<int:poll_id>/contestants/<int:contestant_id>/',
         ContestantDetails.as_view(), name='contestant-details'),
    path('<int:poll_id>/contestants/<int:contestant_id>/update/',
         ContestantUpdateView.as_view(), name='contestant-update'),
    path('<int:poll_id>/contestants/<int:contestant_id>/delete/',
         DeleteContestantView.as_view(), name='contestant-delete'),
]
