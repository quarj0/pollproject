...
class AccountBalanceView(APIView):
	...
	def get(self, request):
		try:
			...
			# Calculate total amount collected from successful vote transactions
			for poll in polls:
				...
				total_amount_collected += poll_revenue
			...
			# Calculate available balance (60% of total collected minus withdrawals)
			creator_share = total_amount_collected * Decimal('0.6')
			available_balance = creator_share - total_withdrawn
